...
activity = Activity.new({ activity_type: "email", contact_id: tim.id, note: "Emailed to set up a time to chat." })
activity.save
activity = Activity.new({ activity_type: "call", contact_id: tim.id, note: "Good initial chat. Will follow up." })
activity.save
